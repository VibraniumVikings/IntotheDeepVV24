...
import org.firstinspires.ftc.teamcode.drive.VVTwoWheelTrackingLocalizer;
...
public class vvRoadRunnerDrive extends MecanumDrive {
    ...
    public vvRoadRunnerDrive(HardwareMap hardwareMap) {
        ...
        setLocalizer(new VVTwoWheelTrackingLocalizer(hardwareMap, this));
