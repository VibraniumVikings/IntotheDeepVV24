...
public class TwoWheelLocalizer extends Localizer { // todo: make two wheel odo work
    ...
    public static double FORWARD_TICKS_TO_INCHES = (0.944882 * 2 * Math.PI)/2000;
    public static double STRAFE_TICKS_TO_INCHES = (0.944882 * 2 * Math.PI)/2000;
    ...
    public TwoWheelLocalizer(HardwareMap map, Pose setStartPose) {
        ...
        forwardEncoderPose = new Pose(-5.5, -2, 0); //-5.25,3.5
        strafeEncoderPose = new Pose(-5, 0, Math.toRadians(90)); //-5.25,0.25
        ...
        forwardEncoder = new Encoder(hardwareMap.get(DcMotorEx.class, "FRM"));
        strafeEncoder = new Encoder(hardwareMap.get(DcMotorEx.class, "FLM"));
