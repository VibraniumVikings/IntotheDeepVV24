...
/*
 * New hardware class for the ITD (Into The Deep) game with printed claw
 * Need to add single arm motor, extension motor, wrist, and claw
 */


public class vvHardwareITDClaw {
    ...
    */
    public static final double clawClose      =  0.9 ; //Metal 13D Print 0.9
    ...
    public static final double floorPick = 0.4 ; //Metal 0.1 3D Print 0.45
    ...
    final public int armHighCaNew = 1275;
    ...
    final public int extArmFLoorPick = 500; //Metal 290, 3D Print 475
    ...
    public vvHardwareITDClaw(LinearOpMode opmode) {
        myOpMode = opmode;
    }
