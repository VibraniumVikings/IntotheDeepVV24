...
public class FollowerConstants {
    ...
    private static double xMovement = 69.6;//73.56
    private static double yMovement = 51.9; //53.17
    ...
    public static double mass = 13.42633;
    ...
    public static double forwardZeroPowerAcceleration = -28.28; //-33.2

    // Acceleration of the drivetrain when power is cut in inches/second^2 (should be negative)
    // if not negative, then the robot thinks that its going to go faster under 0 power
    public static double lateralZeroPowerAcceleration = -67.37; //-72.5
